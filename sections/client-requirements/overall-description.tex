  ...
  \item {
    ...
    \begin{description}
      ...
      \item {
        ...
        Specifies a file to write out to.  Otherwise writes to \inlinecode{STDOUT}.
      }
      \item {
...
It will be assumed that the user of our application is viewed on a fairly modern monitor.
