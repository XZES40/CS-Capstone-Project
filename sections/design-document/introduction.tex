...
XZES40-Transformer is an application for transforming one XML with one XSLT document for the purposes of data transformation, similar to data transformation in a spreadsheet program.
The uses for this rage widely from business to scientific to personal.
Most importantly, any XML/XSLT document transformer needs to be able to handle a high volume of requests by a wide variety of clients.
To address these needs the XZES40 team is building an Open Source XML/XSLT document transformer with key optimization built in to improve the document transformation process; helping businesses, institutions, and individuals get more done in a day.
